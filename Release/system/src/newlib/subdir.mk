...
system/src/newlib/startup.o: ../system/src/newlib/startup.c system/src/newlib/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: GNU Arm Cross C Compiler'
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -Wall -Wextra -g -DNDEBUG -DSTM32F401xE -DUSE_HAL_DRIVER -DHSE_VALUE=8000000 -DOS_INCLUDE_STARTUP_INIT_MULTIPLE_RAM_SECTIONS -I"../include" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32f4-hal" -I"D:\SBME 3nd yaer\2nd term\Embeded system\lab8\Lib" -I"D:\SBME 3nd yaer\2nd term\Embeded system\lab8\EXTI" -I"D:\SBME 3nd yaer\2nd term\Embeded system\lab8\Rcc" -I"D:\SBME 3nd yaer\2nd term\Embeded system\lab8\Gpio" -I"D:\SBME 3nd yaer\2nd term\Embeded system\lab8\Keypad" -I"D:\SBME 3nd yaer\2nd term\Embeded system\lab8\Nvic" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
